...
<p>
    <img src="/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/getting-started.png" alt="NetBird Get Started Intune MDM" className="imagewrapper-big"/>
</p>
...
![Intune Roles](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/lDyaAeV.png)
...
![NetBird Create Application](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/create-app.png)
...
![Intune App Registration](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/Yxxktk6.png)

Fill in the required information:

![Intune Register an App](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/register-app.png)
...
![Intune App Registered](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/7WYZMW6.png)
...
![NetBird Add API Permissions](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/api-permissions.png)
...
![Intune API Permissions](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/V0aRf7f.png)

Look for the `+ Add a permission` button, located near the top of the permissions list and click on it.

![Intune API Permissions Screen](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/Qy9lDMF.png)

A new pop-up window will appear, asking you to select an API. Click on `Microsoft Graph`.

![Intune Microsoft Graph](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/tP7WqXO.png)
...
![Intune Request API Permissions](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/zSkSGAm.png)
...
![Intune UserReadAll](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/device-permissions.png)
...
![Intune API Permissions Warnings](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/grant-permissions.png)
...
![Intune API Permissions Granted](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/granted-permissions.png)
...
![NetBird Generate Client Secret](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/client-secret.png)
...
![EntraID Add a Client Secret](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/WIercn5.png)
...
![EntraID Client Secret Value](/docs-static/img/access-control/endpoint-detection-and-response/microsoft-entra-id-sync/LimVmGI.png)
...
![NetBird Application ID and Directory](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/client-id.png)
...
![Intune Groups](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/groups.png)
...
<p>
    <img src="/docs-static/img/access-control/endpoint-detection-and-response/edr-approval-required.png" alt="edr-approval-required" className="imagewrapper-big"/>
</p>
