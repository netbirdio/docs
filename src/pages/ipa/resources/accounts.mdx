...
<Row>
  <Col>
    ...
    <Property name="network_range_v6" type="string" required={false}>
    ...
    <Property name="local_mfa_enabled" type="boolean" required={false}>
    ...
    <Property name="ipv6_enabled_groups" type="string[]" required={false}>
