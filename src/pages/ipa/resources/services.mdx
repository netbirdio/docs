...
## Delete a self-hosted proxy cluster  {{ tag: 'DELETE' , label: '/api/reverse-proxies/clusters/{clusterAddress}' }}
...
<Row>
  <Col>
    ...
    <Properties>
          ...
          <Property name="clusterAddress" type="string" required={true}> 
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="DELETE" label="/api/reverse-proxies/clusters/{clusterAddress}">
```bash {{ title: 'cURL' }}
