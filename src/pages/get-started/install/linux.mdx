...
<Note>
If you are running a distribution in the RHEL family, you must first install [EPEL](https://docs.fedoraproject.org/en-US/epel/getting-started/). RHEL 9 and earlier do not ship GTK 4 which means only RHEL 10+ is supported.
</Note>
