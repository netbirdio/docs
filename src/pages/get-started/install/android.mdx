...
If you want to keep an APK install up to date automatically, you can add the NetBird repository as a source in [Obtainium](https://github.com/ImranR98/Obtainium), a third-party app that tracks GitHub releases and can install updates for you:
...
<Note>
Google Play is the recommended way to install and update NetBird on Android. Obtainium is a third-party project that is not maintained, monitored, or supported by NetBird. Please report any issues with the Obtainium installation flow to the Obtainium project.
</Note>
