...
Starting from version [0.24.0](https://github.com/netbirdio/netbird/releases/tag/v0.23.9), we have introduced **experimental** support for SQLite.
...
```
7. Check logs to config the store switch:
```bash
