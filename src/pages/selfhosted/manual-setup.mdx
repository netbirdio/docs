...
- Compare all [supported reverse proxy configurations](/selfhosted/external-reverse-proxy), including combined and legacy layouts.
- Use [Manual multi-container setup](/selfhosted/manual-setup/multi-container) only when reproducing or maintaining the legacy separate-service architecture.
