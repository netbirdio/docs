...
- **A domain for the proxy** - e.g., `proxy.example.com` or `netbird.example.com. Service subdomains will be created under this domain (e.g., `myapp.netbird.example.com`)
