...
- **A domain for the proxy** - e.g., `proxy.example.com` or `netbird.example.com; it can be the same domain as the NetBird server. Service subdomains will be created under this domain (e.g., `myapp.netbird.example.com`)
