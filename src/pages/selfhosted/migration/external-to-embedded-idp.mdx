...
```json
{
  ...
  "id": "zitadel",
  "config": {
    "issuer": "https://<your-zitadel-domain>", // Root domain of your zitadel instance, e.g. https://zitadel.example.com 
    "clientID": "<client-id>", // from step 5
    "clientSecret": "<client-secret>", // from step 5
    "redirectURI": "https://<your-management-domain>/oauth2/callback" // same as you use to log in to management dashboard (e.g. https://management.example.com/oauth2/callback)
  }
}
```
