...
This Dashboard-based configuration is simpler, more maintainable, and does not require editing `management.json`. To configure your external IdP with this method, please refer to our [identity provider documentation](/selfhosted/identity-providers).
