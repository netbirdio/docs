...
**New deployments:** The `getting-started.sh` script can automatically configure your reverse proxy. Select your proxy type when prompted during initial setup.
...
- Complete configuration templates for Traefik, Nginx, Caddy, and Nginx Proxy Manager
