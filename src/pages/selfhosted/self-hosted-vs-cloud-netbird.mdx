...
- **[Event streaming](https://docs.netbird.io/how-to/activity-event-streaming)** to 3rd parties.
- **[EDR integrations](https://docs.netbird.io/how-to/endpoint-detection-and-response)** (e.g., CrowdStrike).
- **[Identity provider synchronization](https://docs.netbird.io/how-to/idp-sync)** of users and groups.
- **[Peer approval](/docs.netbird.io/how-to/approve-peers)**.
...
When using the cloud-hosted version, you benefit from the geo-distributed relay servers that are located in multiple regions
...
When using the self-hosted version, you need to set up your own relay servers. This can be a complex task and requires additional
maintenance effort.
