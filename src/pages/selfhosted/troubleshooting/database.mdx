...
2. **A skipped intermediate version.** Major version jumps may require stepping through intermediate releases. Follow the [upgrade path](/selfhosted/selfhosted-quickstart#upgrade) for your version.
