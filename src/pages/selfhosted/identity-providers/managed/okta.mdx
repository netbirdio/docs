...
Add Okta as an embedded IdP directly in the NetBird Management Dashboard. This is the simplest approach and recommended for most deployments.
...
NetBird displays the **Redirect URL**. Copy this URL and add it to your Okta application:
