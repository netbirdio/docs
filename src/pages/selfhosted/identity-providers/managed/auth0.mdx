...
5. **Don't click Create yet** — keep this tab open and proceed to Step 2
...
| Issuer | `https://your-tenant.auth0.com` (replace with your Auth0 domain) |
...
4. Under **Allowed Callback URLs**, add the redirect URL you copied from NetBird
5. Click **Save Changes**
6. Note the **Client ID**, **Client Secret**, and **Domain** (e.g., `your-tenant.auth0.com`) — you'll need these for Step 4
