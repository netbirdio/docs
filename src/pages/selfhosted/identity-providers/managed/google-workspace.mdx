...
Add Google as an embedded IdP directly in the NetBird Management Dashboard. This is the simplest approach and recommended for most deployments.
...
<Note>
Google doesn't require an Issuer URL—it's determined automatically.
</Note>
