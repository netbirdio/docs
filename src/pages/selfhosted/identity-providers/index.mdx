...
This allows users to sign in with their existing accounts from services like Google, Microsoft, or your corporate identity
...
| [**PocketID**](/selfhosted/identity-providers/pocketid) | `pocketid` | Lightweight OIDC provider with passkey authentication |
