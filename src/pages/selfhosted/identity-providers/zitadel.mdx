...
<Note>
Zitadel was previously used in the NetBird quickstart script. If you have an existing Zitadel deployment, you can continue using it as a standalone IdP or migrate to the embedded IdP with Zitadel as an embedded IdP directly in the NetBird Management Dashboard.
</Note>

## Management Setup (Recommended)

Add Zitadel as an embedded IdP directly in the NetBird Management Dashboard. This is the simplest approach for new deployments or when migrating from the previous quickstart.
...
**Option B - Add Zitadel as embedded IdP directly in NetBird Management Dashboard**:
1. Deploy new NetBird version with embedded IdP
2. Add your existing Zitadel as an embedded IdP directly in the NetBird Management Dashboard (follow Management Setup above)
