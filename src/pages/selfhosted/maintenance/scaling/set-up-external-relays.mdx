...
server:
  ...
  # Force-enable the embedded STUN alongside external STUN (optional)
  # enableLocalSTUN: true
  # Force-enable the embedded relay alongside external relay (optional)
...
### Using Embedded and External Services Together
