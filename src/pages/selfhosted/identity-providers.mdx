...
```json
{
  ...
  "KeycloakClientCredentials": {
      ...
      "ClientSecret": "<NETBIRD_BACKEND_CLIENT_SECRET>",
      "GrantType": "client_credentials",
      "TokenEndpoint": "https://<YOUR_KEYCLOAK_HOST_AND_PORT>/realms/netbird/protocol/openid-connect/token",
      "AdminEndpoint": "https://<YOUR_KEYCLOAK_HOST_AND_PORT>/admin/realms/netbird"
  }
}
  ```
