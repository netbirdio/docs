...
NETBIRD_MGMT_CLIENT_ID="netbird"
NETBIRD_MGMT_CLIENT_SECRET="<CLIENT SECRET>"
NETBIRD_IDP_MGMT_EXTRA_MANAGEMENT_ENDPOINT="https://<YOUR-ZITADEL-HOST-AND-PORT>/management/v1"
...
NETBIRD_MGMT_CLIENT_ID="<PROVIDER Client ID>"
