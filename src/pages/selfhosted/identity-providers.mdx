...
- Open downloaded json file and take note of `client_id` will be used later as `Service Account Client ID` and `client_email` will be used later as `Service Account Email`
