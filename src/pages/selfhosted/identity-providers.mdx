...
- Navigate to to [Admin Console](https://console.jumpcloud.com/) page
- Click `SSO` on the left menu under `USER AUTHENTICATION` section
- Click `Add New Application` and select `Custom OIDC App`
<p>
...
- Take note of `Client ID` and `Client Secret`, will be used later

#### Step 2: Generate api token
In this step, we will generate netbird api token in jumpcloud for authorizing calls to user api.

- Navigate to to [Admin Console](https://console.jumpcloud.com/) page
- Click your account initials displayed at the top-right and select `My API Key` from the drop-down
