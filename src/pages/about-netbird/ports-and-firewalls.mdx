...
|---|---|---|
| Palo Alto Networks | Connects, relayed if the security policy blocks outbound UDP | Permit the STUN/TURN endpoints, and exclude the NetBird domains from the SSL Decryption policy |
