...
Below is the list of **NetBird Cloud** endpoints and ports they listen to. If you are self-hosting NetBird, your clients connect to your own server endpoints instead — see the [self-hosted guide port requirements](/selfhosted/selfhosted-guide#port-requirements).
* Management service:
