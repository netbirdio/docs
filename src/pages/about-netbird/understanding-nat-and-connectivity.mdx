...
NetBird provides globally distributed relay servers to ensure connectivity even in the most restrictive networks. The relay system supports two transport protocols:
