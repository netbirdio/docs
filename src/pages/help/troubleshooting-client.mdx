...
The generated path is shown in the CLI or desktop app. If the operating system's temporary directory has been
overridden, use the displayed path instead. The ZIP is owned by the account running the NetBird daemon: `root` on
