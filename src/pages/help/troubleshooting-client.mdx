...
UFW is a frontend to iptables commonly used on Ubuntu. Its default policy denies all incoming traffic, 
...
NetBird creates a Windows Firewall rule automatically. If traffic is blocked:
