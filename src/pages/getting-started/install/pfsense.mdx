...
- A [setup key](/manage/peers/setup-keys#types-of-setup-keys) to authenticate and register the pfSense device
...
<p>
    <img src="/docs-static/img/platforms/pfSense/authentication.png" alt="authentication" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/platforms/pfSense/status.png" alt="connection status" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/platforms/pfSense/new_interface.png" alt="NewInterface" className="imagewrapper-big"/>
</p>
...
<p> <img src="/docs-static/img/platforms/pfSense/enable_interface.png" alt="enableInterface" className="imagewrapper-big"/> </p>
...
<p><img src="/docs-static/img/platforms/pfSense/firewall_rules.png" alt="firewallRules" className="imagewrapper-big"/></p>
