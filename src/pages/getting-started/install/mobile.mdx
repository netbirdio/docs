...
<p>
    <a href="https://play.google.com/store/apps/details?id=io.netbird.client" target="_blank">
        <img src="/docs-static/img/platforms/mobile/google-play-badge.png" alt="playstore" className="imagewrapper"/>
    </a>
...
<p>
    <a href="https://apps.apple.com/de/app/netbird-p2p-vpn/id6469329339?l=en-GB" target="_blank">
        <img src="/docs-static/img/platforms/mobile/app-store-badge.svg" alt="appstore" className="imagewrapper" style={{ padding: '30px' }}/>
    </a>
</p>
