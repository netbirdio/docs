...
- A [setup key](/manage/peers/setup-keys#types-of-setup-keys) to authenticate and register the OPNsense device
...
<p>
    <img src="/docs-static/img/platforms/opnsense/authentication.png" alt="authentication" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/platforms/opnsense/status.png" alt="connection status" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/platforms/opnsense/interface_assignment.png" alt="interfaceAssignment" className="imagewrapper-big"/>
</p>

Click `Add` to assign the interface.
<p>
    <img src="/docs-static/img/platforms/opnsense/new_interface.png" alt="interfaceAssignment" className="imagewrapper-big"/>
</p>
...
<p> <img src="/docs-static/img/platforms/opnsense/enable_interface.png" alt="enableInterface" className="imagewrapper-big"/> </p>
...
<p>
    <img src="/docs-static/img/platforms/opnsense/firewall_rules.png" alt="firewallRules" className="imagewrapper-big"/>
</p>
