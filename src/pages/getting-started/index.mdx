...
Next, let's add a second, headless peer, like a Linux server or a Raspberry Pi. For devices without a graphical interface, we use a [Setup Key](https://docs.netbird.io/manage/peers/setup-keys).
...
* [Setup Keys](https://docs.netbird.io/manage/peers/setup-keys): Create and manage keys for adding new headless or ephemeral devices.
