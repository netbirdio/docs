...
```shell
kdn@oams ~> ssh brys-vm-ubuntu-01.lan.etra.net.int.kdn.im. "curl -m 2 192.168.100.10/health; echo"
...
kdn@oams ~ [1]> ssh 192.168.100.215 -J brys.lan.etra.net.int.kdn.im. "nc -w 2 192.168.122.65 22"
