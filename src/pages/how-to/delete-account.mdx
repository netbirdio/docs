...
To delete your NetBird organization account, you must be a user with the Owner role. You can ask the owner to delete the organization account if you are not the account owner.
Learn more about user roles at [Manage user roles](/how-to/add-users-to-your-network#manage-user-roless).
## Delete your account
<Note>
