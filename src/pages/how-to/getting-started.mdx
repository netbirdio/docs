...
Welcome to NetBird! This guide will walk you through our new onboarding process to create your account, connect your first devices, and build a secure peer-to-peer overlay network in minutes.

<div className="videowrapper">
    <iframe src="https://www.youtube.com/embed/dr0u-u9uD84" allow="fullscreen;"></iframe>
*This guide describes how to quickly get started with NetBird using the new onboarding process.*
</div>
...
2. You will be directed to the sign-in page. NetBird integrates with your existing [identity provider (IdP)](https://netbird.io/knowledge-hub/enhancing-network-access-control-with-idp-sync) for secure authentication. NetBird also support any OIDC compliant provider. Select your preferred option to sign up. 
3. Follow the authentication steps for your chosen provider. If you have Multi-Factor Authentication (MFA) enabled on your IdP account, it will work automatically.

<Note>
    If you manage users and groups with your identity provider, you can actually provision and sync them with NetBird. Learn more [here](https://docs.netbird.io/how-to/idp-sync) including the supported platforms.
</Note>
...
The onboarding process will now guide you to connect your first device, also known as a peer. For this guide, we'll select Peer-to-Peer Network. If you’re selecting the Remote Network Access option, you can see that process [here](http://localhost:3000/how-to/getting-started#remote-network-access).
...
```bash
netbird up --setup-key <YOUR-UNIQUE-SETUP-KEY>
```
...
3. Re-enabling the policy instantly restores the connection. This gives you a basic understanding of how you can control traffic within your network. You can learn much more about policies here.
...
The onboarding process will now guide you to build our first Network Resource. For this guide, we'll select Remote Network Access. If you’re selecting the Peer-to-Peer option, you can see that process here.
...
## Onboarding Complete!
Congratulations! You have successfully onboarded and created your first secure network with two peers.
