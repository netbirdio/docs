...
2. You will be directed to the sign-in page. NetBird integrates with your existing identity provider (IdP) for secure authentication.
NetBird also support any OIDC compliant provider. Select your preferred option to sign up.
