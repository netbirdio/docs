# Setup Keys: Add Servers to the Network
...
This guide introduces [NetBird's Setup Keys](https://docs.netbird.io/how-to/register-machines-using-setup-keys) as an elegant solution for seamlessly and securely adding servers and containers to your network by:
...
Let's dive into the step-by-step process of using NetBird's Setup Keys to securely add a server with a Docker container to your network.
...
![NetBird Generating Setup Key](/public/docs-static/img/how-to-guides/setup-keys-add-servers-to-network/setup-keys-add-server-01.png)

This setup key will serve as your secure passport for adding both your VM and Docker container to the NetBird network, ensuring a streamlined and consistent integration process. 
...
![NetBird Peers View](/public/docs-static/img/how-to-guides/setup-keys-add-servers-to-network/setup-keys-add-server-02.png)
...
![NetBird Peers IP Address or Domain](/public/docs-static/img/how-to-guides/setup-keys-add-servers-to-network/setup-keys-add-server-03.png)
...
![NetBird Welcome Page](/public/docs-static/img/how-to-guides/setup-keys-add-servers-to-network/setup-keys-add-server-04.png)
