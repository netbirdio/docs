...
The NetBird Kubernetes operator automatically creates [Networks and Resources](/manage/networks/networks) in your NetBird account, allowing you to
...
or by following [this guide](/manage/peers/setup-keys) for more details.
