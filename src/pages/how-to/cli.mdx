...
```shell
      --disable-profiles          Disables profiles feature. If enabled, the client will not be able to change or edit any profile.
```
...
<Note>
    If you installed the service with `--disable-profiles`, this setting will persist and profiles will remain disabled when the service starts.
</Note>
...
<Note>
    If you installed the service with `--disable-profiles`, this setting will persist and profiles will remain disabled when the service restarts.
</Note>
