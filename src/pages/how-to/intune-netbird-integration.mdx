...
- Download your preferred NetBird Windows installer from the [NetBird installation documentation](https://docs.netbird.io/getting-started/install#windows)
...
- Download the NetBird Windows MSI installer from the [NetBird installation documentation](https://docs.netbird.io/getting-started/install#windows)
- Sign in to the [Microsoft Intune admin center](https://intune.microsoft.com), navigate to `Apps`, and click the `Windows` button.
