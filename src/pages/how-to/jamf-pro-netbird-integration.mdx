# Integrating NetBird's VPN Solution with Jamf Pro

Integrating NetBird's powerful VPN solution with Jamf Pro's robust device management capabilities creates a scalable system for secure access management across your entire Apple ecosystem.
