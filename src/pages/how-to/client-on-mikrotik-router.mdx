...
Our container is now ready and conatiner image pull from DockerHub should have been triggered. We can check the RouterOS logs to see if the pull was successful
...
ERRO client/internal/routemanager/systemops/systemops_linux.go:100: Error setting up sysctl: 1 errors occurred:
...
ERRO util/grpc/dialer.go:38: Failed to dial: dial: dial tcp: lookup signal.netbird.io on 172.17.0.1:53: read udp 172.17.0.2:34638->172.17.0.1:53: i/o timeout
```
