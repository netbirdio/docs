...
Please follow the instructions below for your provider ([Authentik](#authentik-id-p) or [Keycloak](#keycloak-id-p)) and then share the information requested with the NetBird support team at support@netbird.io
