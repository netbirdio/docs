...
<Note>
    This feature is only applied to peers added with the [interactive SSO login feature](/getting-started/install#running-net-bird-with-sso-login). Peers, added with a setup key, won't be affected.
</Note>
