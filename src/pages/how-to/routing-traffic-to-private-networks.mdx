...
You can use peer groups as routers to automatically add any Linux peer from the groups as routing peers. To do so follow similar steps as above but select the `Peer groups` tab. You should have peers assigned to groups.
