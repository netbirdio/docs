...
### Creating a network route with group routing 
You can use peer groups as routers. To do so follow similar steps as above but select the `Group of Peers` tab. You should have peers assigned to peers.
