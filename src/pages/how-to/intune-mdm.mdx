...
<Note>
    **WARNING:** As of November 15 2025, this page was moved [here](/access-control/endpoint-detection-and-response/intune-mdm) as an effort to better organize and update our documentation. This page is no longer being updated and will soon be deleted and redirected automatically to the new page. 
</Note>
