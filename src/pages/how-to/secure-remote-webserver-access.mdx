...
![NetBird Local Peer](https://i.imgur.com/owyUeUn.png)
...
![NetBird Creating Setup Key](https://i.imgur.com/jQ5rhEb.png)
...
![NetBird Peers Network](https://i.imgur.com/8I1WVEx.png)
...
![NetBird Access Policy](https://i.imgur.com/AgB9Asr.png)
...
![NetBird Web Server Peer](https://i.imgur.com/QXb6lLs.png)
...
![NetBird IP Addresses](https://i.imgur.com/EVZssES.png)
...
![NetBird Local User Peer](https://i.imgur.com/LoNxwd4.png)
...
![Terminal No Access to Web Server](https://i.imgur.com/iHiFujr.png)

There is no response from the host. Now, ping the web server from your configured local machine:

![Terminal Access to Web Server](https://i.imgur.com/HKsAcFE.png)
...
![Terminal Fastfetch from Web Server](https://i.imgur.com/YoECY8k.png)
