...
#### Confirming the DNS names resolve properly in practice
...
#### Confirming the nameservers are properly registered in Windows operating system
...
#### Confirming the nameservers are properly registered in MacOS operating system
...
#### Confirming the nameservers are properly registered in Linux operating system
