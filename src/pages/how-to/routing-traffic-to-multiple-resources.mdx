...
The network address is `172.16.0.0/15` and the DNS server has the IPs `172.16.30.2` and `172.17.100.2`.
...
Now, let's add the DNS server resources to the network. Click on `Add Resource` and enter the IP address of the first DNS server:
<p>
