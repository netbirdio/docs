...
Refer to the [api.md](../../../misc/idp-sync/api.md) document for detailed instructions on how to create the integration.
...
- Navigate to Okta Admin Dashboard
- Click `Applications` in the left menu and then click on `Applications`
- Select the `NetBird` application we created ealier
