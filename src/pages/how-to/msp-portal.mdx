...
When an account already exists in our system for the supplied tenant domain, you'll need to explicity "Request Access" that the existing account Owner will have Grant the next time they login to their account:
