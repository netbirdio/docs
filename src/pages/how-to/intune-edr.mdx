...
<p>
    <img src="/docs-static/img/how-to-guides/intune-edr/getting-started.png" alt="NetBird Get Started Intune EDR" className="imagewrapper-big"/>
</p>
...
![NetBird Create Application](/docs-static/img/how-to-guides/intune-edr/create-app.png)
...
![Intune Register an App](/docs-static/img/how-to-guides/intune-edr/register-app.png)
...
![NetBird Add API Permissions](/docs-static/img/how-to-guides/intune-edr/api-permissions.png)
...
![Intune UserReadAll](/docs-static/img/how-to-guides/intune-edr/device-permissions.png)
...
![Intune API Permissions Warnings](/docs-static/img/how-to-guides/intune-edr/grant-permissions.png)
...
![Intune API Permissions Granted](/docs-static/img/how-to-guides/intune-edr/granted-permissions.png)
...
![NetBird Generate Client Secret](/docs-static/img/how-to-guides/intune-edr/client-secret.png)
...
![NetBird Application ID and Directory](/docs-static/img/how-to-guides/intune-edr/client-id.png)
