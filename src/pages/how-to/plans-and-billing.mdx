...
for IoT use cases where there is a large number of machines on the network but comparatively fewer users. This feature is available under both our Team and Business Plan. Simply subscribe to the Team or Business Plan, and we'll automatically adjust the machine costs as detailed in the following sections.
