...
to internal networks like VPCs, office networks, and internal services without running the NetBird client on the remote resources using the [NetBird Networks](/manage/networks/networks) feature.
...
you used the [NetBird Networks feature](/manage/networks/networks) and created a network resource for the CRM server. In this case, if a user accessed an internal CRM from their laptop via a browser
