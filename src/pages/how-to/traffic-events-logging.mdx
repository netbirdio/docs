...
<Note>
 Traffic events data retention is limited to 48 hours and capped at a maximum of 50,000 events. These limits will be increased when the feature reach GA maturity.
</Note>
