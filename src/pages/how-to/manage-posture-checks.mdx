...
<Note>
    **WARNING:** As of November 15 2025, this page was moved [here](/access-control/posture-checks) as an effort to better organize and update our documentation. This page is no longer being updated and will soon be deleted and redirected automatically to the new page. 
</Note>
...
Let's delve into the details of how [NetBird's Posture Checks](https://docs.netbird.io/access-control/posture-checks) feature transforms access control, making it more secure, efficient, and adaptable for modern enterprises.
