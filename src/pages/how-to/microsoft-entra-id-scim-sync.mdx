...
![Microsoft Entra ID SCIM Integration Connection](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-connect.png)
...
![Microsoft Entra ID SCIM Getting Started Wizard](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-scim-getting-started.png)
...
![Microsoft Entra ID SCIM Configuration Setup](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-configure-scim.png)
...
![Microsoft Entra ID New Application Creation](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-new-application.png)
...
![Microsoft Entra ID Application Form](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-application-form.png)

Click `Create`.

![Microsoft Entra ID Application Created Successfully](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-application-created.png)
...
![Microsoft Entra ID Enable Provisioning Setup](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-enable-provisioning.png)
...
![Microsoft Entra ID Provisioning Get Started](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-provisioning-get-started.png)
...
![Microsoft Entra ID Connect Application Configuration](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-connect-application.png)
...
![Microsoft Entra ID Configure Attribute Mapping](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-configure-attribute-mapping.png)
...
![Microsoft Entra ID Default Attribute Mapping](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-default-attribute-mapping.png)
...
![Microsoft Entra ID Edit External ID Attribute](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-edit-externalid.png)

Click `Ok` to save the change, then click `Save` to apply the new attribute mapping configuration.

![Microsoft Entra ID Updated Attribute Mapping](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-updated-attribute-mapping.png)
...
![Microsoft Entra ID Assign Users and Groups](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-assign-users-and-groups.png)
...
![Microsoft Entra ID Assign Users and Groups Interface](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-assign-users-groups.png)
...
![Microsoft Entra ID Run Provisioning](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-run-provisioning.png)
...
![Microsoft Entra ID Provisioning Started](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-provisioning-started.png)
...
![Microsoft Entra ID SCIM Configuration Options](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-configuration-options.png)
...
![Microsoft Entra ID Regenerate Authentication Token](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-regenerate-auth-token.png)
...
![Microsoft Entra ID Group Prefix Filter](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-group-prefix.png)
...
![Microsoft Entra ID User Prefix Filter](/docs-static/img/how-to-guides/entra-id-scim-sync/entra-user-prefix.png)
