export const description =
  'Connect specific agent tools, providers, and gateways to NetBird Agent Network — Claude Code, Codex, LiteLLM, vLLM, Google Vertex AI, AWS Bedrock, and Kimi (Moonshot AI).'
