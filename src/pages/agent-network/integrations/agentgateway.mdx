...
<Note>
  agentgateway support is being tracked in
  [netbirdio/netbird#6970](https://github.com/netbirdio/netbird/issues/6970). Until a NetBird
  release includes that work, use the development images only for testing.
</Note>
...
For a complete Kubernetes deployment with OpenAI and Anthropic routes, strict virtual-key
authentication, NetworkPolicy, and verification scripts, see the
[NetBird Agent Network example](https://github.com/agentgateway/agentgateway/tree/main/examples/netbird-agent-network)
in the agentgateway repository.
