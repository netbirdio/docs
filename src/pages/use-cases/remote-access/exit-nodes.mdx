...
<Note>
    Build this in **Networks**. Adding a posture check to a Peers-page exit node does not work: the default route still installs on every peer in the distribution groups, and devices failing the check lose internet entirely.
</Note>
