...
### Deploy NetBird in the cloud and Kubernetes
...
| Connect Kubernetes workloads to external networks | [Routing Peers and Kubernetes](/use-cases/cloud/routing-peers-and-kubernetes) |
| Expose a single Kubernetes service | [Route to a Kubernetes Service](/use-cases/cloud/route-to-a-kubernetes-service) |
