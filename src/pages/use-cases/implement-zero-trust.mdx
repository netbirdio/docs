...
# 3) TURN service (for relayed connections):
# Provides relay when P2P and STUN fail
ALLOW OUT UDP 80,443 to turn.netbird.io
ALLOW OUT TCP 443-65535 to turn.netbird.io

# 4) Fallback relay servers:
