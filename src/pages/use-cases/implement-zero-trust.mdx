...
- **Device posture checks** for OS, client version, geo, CIDR, processes (see [Section 4.2](#42-posture-checks-and-their-limits))
- **Connection traffic events logging** for flow visibility (see [Section 7](#7-visibility-traffic-events-siem-and-control-center))
- **Audit and traffic events streaming** to Datadog, S3, Firehose, generic HTTP for SIEM integration (see [Section 7](#7-visibility-traffic-events-siem-and-control-center))
