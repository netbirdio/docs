...
- [Run a Private Reverse Proxy with LEGO](/use-cases/security/private-proxy-with-lego) — a complete Docker Compose walkthrough of this pattern with LEGO, a wildcard certificate directory, and automated renewal.
