...
<p>
    <Video src="/docs-static/img/manage/access-control/policy-direction.mp4"
           label="Policy directionality: toggling between one-way and bidirectional traffic in the policy editor"/>
</p>
