...
<Note>
For a complete list of NetBird endpoints, IP addresses, and detailed firewall configuration examples, see the [Ports & Firewalls](/about-netbird/ports-and-firewalls#network-firewall-ports)
</Note>
...
<Note>
- For a list of outbound ports required for NetBird Cloud, see the [Ports & Firewalls](/about-netbird/ports-and-firewalls#network-firewall-ports)
