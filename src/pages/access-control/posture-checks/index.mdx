...
![NetBird Posture Checks](/docs-static/img/access-control/posture-checks/posture-checks-01.png)

A pop-up window will open with two tabs: `Checks` and `Name & Description`.

![Create Posture Check](/docs-static/img/access-control/posture-checks/posture-checks-02.png)
...
![NetBird Client Version Posture Check](/docs-static/img/access-control/posture-checks/posture-checks-03.png)
...
![Country and Region Posture Check](/docs-static/img/access-control/posture-checks/posture-checks-04.png)
<Note>
...
![Peer Network Range Posture Check](/docs-static/img/access-control/posture-checks/posture-checks-05.png)
...
![Operating System Posture Check](/docs-static/img/access-control/posture-checks/posture-checks-06.png)
<Note>
...
![Process Posture Check](/docs-static/img/access-control/posture-checks/posture-checks-07.png)
...
![Name your Posture Check](/docs-static/img/access-control/posture-checks/posture-checks-08.png)
...
![New Posture Check](/docs-static/img/access-control/posture-checks/posture-checks-09.png)
...
![Add Posture Check to Access Control Policy](/docs-static/img/access-control/posture-checks/posture-checks-10.png)
...
![Access Control Policies Dashboard](/docs-static/img/access-control/posture-checks/posture-checks-11.png)
...
![Posture Checks Dashboard](/docs-static/img/access-control/posture-checks/posture-checks-12.png)
