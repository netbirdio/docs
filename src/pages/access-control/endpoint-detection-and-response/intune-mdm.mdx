...
![Intune Roles](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/lDyaAeV.png)
...
![Intune App Registration](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/Yxxktk6.png)
...
![Intune App Registered](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/7WYZMW6.png)
...
![Intune API Permissions](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/V0aRf7f.png)

Look for the `+ Add a permission` button, located near the top of the permissions list and click on it.

![Intune API Permissions Screen](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/Qy9lDMF.png)

A new pop-up window will appear, asking you to select an API. Click on `Microsoft Graph`.

![Intune Microsoft Graph](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/tP7WqXO.png)
...
![Intune Request API Permissions](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/zSkSGAm.png)
...
![EntraID Add a Client Secret](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/WIercn5.png)
...
![EntraID Client Secret Value](/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/LimVmGI.png)
...
<p>
    <img src="/docs-static/img/access-control/endpoint-detection-and-response/intune-mdm/edr-approval-required.png" alt="edr-approval-required" className="imagewrapper-big"/>
</p>
