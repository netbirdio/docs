...
![Endpoint Detection and Response](/docs-static/img/access-control/endpoint-detection-and-response/edr-integrations.png)
...
* [CrowdStrike Falcon](/access-control/endpoint-detection-and-response/crowdstrike-edr)
* [Microsoft Intune](/access-control/endpoint-detection-and-response/intune-mdm)
* [SentinelOne Singularity](/access-control/endpoint-detection-and-response/sentinelone-edr)
