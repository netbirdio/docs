...
connection: `blockInbound`, `wireguardPort`, `lazyConnection`, and
`debugBundleUploadURL` when a remote job produces a bundle. They are
enforced just the same — there is simply nothing on screen to mark.
