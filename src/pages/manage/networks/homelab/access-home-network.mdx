...
<p>
    <img src="/docs-static/img/manage/networks/homelab/login-screen-dark.png" alt="login-to-netbird" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/homelab/add-network-home-lan.png" alt="add-network-home-lan" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/homelab/add-resource-home-network.png" alt="add-resource-home-network" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/homelab/add-policy-home-lan.png" alt="add-policy-home-lan" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/homelab/add-user-group.png" alt="add-network-home-lan" className="imagewrapper"/>
</p>
...
3. Install the NetBird agent on it using a [one-off setup key](/manage/peers/setup-keys#types-of-setup-keys) using the CLI installer.
...
<p>
    <img src="/docs-static/img/manage/networks/homelab/add-routing-peer-home-network.png" alt="add-routing-peer-home-network"
         className="imagewrapper"/>
</p>

<p>
    <img src="/docs-static/img/manage/networks/homelab/add-routing-peer.png" alt="add-routing-peer-home-network"
         className="imagewrapper"/>
</p>
