...
<Tiles
    ...
    items={[
        ...
        },
        {
            ...
            description: 'Reach a file server, SMB, or DFS share that runs the agent itself.',
        },
    ]}
/>
