...
Every device that runs the NetBird client joins a single private **overlay network**, encrypted end to end with [WireGuard](/about-netbird/why-wireguard-with-netbird). Nothing is exposed to the public internet.
...
<p>
    <img src="/docs-static/img/manage/networks/index/new-network-2.png" alt="Creating a new Network in the dashboard" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/index/resource-list.png" alt="A Network's resource list showing addresses, resource groups, and policies" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/index/worked-example/add-network.png" alt="Creating the Berlin Office Network in the dashboard" className="imagewrapper-medium"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/index/worked-example/add-resource.png" alt="Adding the Internal Wiki resource (10.10.0.5/32) to the Internal Apps group" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/index/worked-example/add-policy.png" alt="An access policy allowing the Development group to reach the Internal Apps group on TCP 443" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/networks/index/worked-example/add-routing-peer.png" alt="Adding the office host as a routing peer for the Berlin Office Network" className="imagewrapper"/>
</p>
...
- **Masquerade.** On by default and the simplest option. Turn it off only when you need source-IP visibility. Note that disabling it breaks high availability and requires a return route. See [Masquerade](/manage/networks/masquerade).
