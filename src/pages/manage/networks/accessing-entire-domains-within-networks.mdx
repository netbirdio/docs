...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/01-domains-within-networks.png"
    alt="Enabling DNS wildcard routing" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/02-domains-within-networks.png"
    alt="Creating Developers Domain Network" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/03-domains-within-networks.png"
    alt="Add Routing Peers Window" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/04-domains-within-networks.png"
    alt="Local Routing Peers" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/05-domains-within-networks.png"
    alt="Masquerade and Metric" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/06-domains-within-networks.png"
    alt="Add Domain Resource" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/07-domains-within-networks.png"
    alt="Add Accounting Website Restricted Subdomain Resource" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/08-domains-within-networks.png"
    alt="Add Policy" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/09-domains-within-networks.png"
    alt="Developers Policy" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/10-domains-within-networks.png"
    alt="Developers Policy Name" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/11-domains-within-networks.png"
    alt="Development Network" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/12-domains-within-networks.png"
    alt="Regular Domain Resource" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/13-domains-within-networks.png"
    alt="Development Network Resources" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/14-domains-within-networks.png"
    alt="AI Network" className="imagewrapper"/>
</p>

As with developers, you can configure a single routing peer or a group of routing peers for high availability:

<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/15-domains-within-networks.png"
    alt="AI Routing Peers" className="imagewrapper"/>
</p>

You can also set up a wildcard domain resource for this environment:

<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/16-domains-within-networks.png"
    alt="AI Wildcard Domain Resource" className="imagewrapper"/>
</p>

And establish an access policy tailored to your data scientists:

<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/17-domains-within-networks.png"
    alt="AI Team Access Policy" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/18-domains-within-networks.png"
    alt="AI Network" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/19-domains-within-networks.png"
    alt="New AI Model Resource" className="imagewrapper"/>
</p>

In summary, you can easily add, remove, and edit network resources from the Networks dashboard.

<p>
  <img src="/docs-static/img/manage/networks/accessing-entire-domains-within-networks/20-domains-within-networks.png"
    alt="AI Training Model Network" className="imagewrapper-big"/>
</p>
