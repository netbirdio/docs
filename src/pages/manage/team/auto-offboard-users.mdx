...
<p>
  <img src="/docs-static/img/manage/team/auto-offboard-users/GT3eAeU.png"
...
<p>
  <img src="/docs-static/img/manage/team/auto-offboard-users/TJWLvXL.png"
    alt="IdP Delete User" className="imagewrapper-big"/>
</p>

After deletion, click the `Refresh` button to confirm that the user is no longer active.

<p>
  <img src="/docs-static/img/manage/team/auto-offboard-users/LJ6QHRV.png"
    alt="IdP Confirm Deletion" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/auto-offboard-users/ogiiUeT.png"
    alt="NetBird Integrations Force Sync" className="imagewrapper-big"/>
</p>

Now, go to NetBird's `Users` dashboard to verify that the user is no longer listed.

<p>
  <img src="/docs-static/img/manage/team/auto-offboard-users/MQ2yh6B.png"
    alt="NetBird Users Verification" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/auto-offboard-users/sATMbbP.png"
    alt="NetBird Access Control" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/auto-offboard-users/TOZjFKC.png"
    alt="IdP Delete Group" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/auto-offboard-users/NKabmN6.png"
    alt="NetBird No Group" className="imagewrapper-big"/>
</p>