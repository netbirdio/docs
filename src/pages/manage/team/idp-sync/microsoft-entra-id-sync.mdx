...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/FkdC8BV.png"
    alt="NetBird Get Started IdP" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/lDyaAeV.png"
    alt="EntraID Roles" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/oI0Pjai.png"
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/Yxxktk6.png"
    alt="EntraID App Registration" className="imagewrapper-big"/>
</p>

Fill in the required information:

<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/1t8qbfK.png"
    alt="EntraID Register an App" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/7WYZMW6.png"
    alt="EntraID App Registered" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/0A98Xm9.png"
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/V0aRf7f.png"
    alt="EntraID API Permissions" className="imagewrapper-big"/>
</p>

Look for the `+ Add a permission` button, located near the top of the permissions list and click on it.

<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/Qy9lDMF.png"
    alt="EntraID API Permissions Screen" className="imagewrapper-big"/>
</p>

A new pop-up window will appear, asking you to select an API. Click on `Microsoft Graph`.

<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/tP7WqXO.png"
    alt="EntraID Microsoft Graph" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/zSkSGAm.png"
    alt="EntraID Request API Permissions" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/KHGbhqe.png"
    alt="EntraID UserReadAll" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/XDl3b7u.png"
    alt="EntraID GroupReadAll" className="imagewrapper-big"/>
</p>

Once done, click the `Add permissions` button. You will see a few warnings:

<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/OGWQWVH.png"
    alt="EntraID API Permissions Warnings" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/bHb8HVZ.png"
    alt="EntraID API Permissions Granted" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/xvLskEg.png"
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/WIercn5.png"
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/LimVmGI.png"
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/6yiGCtY.png"
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/xyLPzxH.png"
    alt="NetBird Group Sync" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/bpwW1Bn.png"
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/DH5hxFK.png"
    alt="NetBird Identity Provider Synchronized" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/microsoft-entra-id-sync/qlNlfgV.png"
    alt="NetBird Checking Integration" className="imagewrapper-big"/>
</p>
