...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-installed.png"
    alt="Keycloak SCIM Installed" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-connect.png"
    alt="NetBird Keycloak Integration" className="imagewrapper-big"/>
</p>

Click the `Connect Generic SCIM` button to begin the configuration process.

<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-getting-started.png"
    alt="NetBird Keycloak Getting Started" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-group-filter.png"
    alt="NetBird Keycloak Group Filter" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-user-group-filter.png"
    alt="NetBird Keycloak User Group Filter" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-credentials.png"
    alt="NetBird Keycloak SCIM Credentials" className="imagewrapper-big"/>
</p>

Click `Finish Setup` to complete the NetBird SCIM configuration.

<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-enabled.png"
    alt="NetBird Keycloak SCIM Enabled" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-login.png"
    alt="Keycloak SCIM Login" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-remote-provider.png"
    alt="Keycloak SCIM Remote Provider" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-config.png"
    alt="Keycloak SCIM Configuration" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-authentication.png"
    alt="Keycloak SCIM Authentication" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-default-schema.png"
    alt="Keycloak SCIM Default Schema" className="imagewrapper-big"/>
</p>

Next, assign the SCIM provider to your realm. Click the `Realm Assignment` tab to view all available realms.

<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-realm-assignment.png"
    alt="Keycloak SCIM Realm Assignment" className="imagewrapper-big"/>
</p>

Find your realm (e.g., `netbird`) and click `Assign to Realm` to enable SCIM synchronization for that realm.

<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-realm-assigned.png"
    alt="Keycloak SCIM Realm Assigned" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-resource-filtering.png"
    alt="Keycloak SCIM Resource Filtering" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/keycloak-scim-filtering-config.png"
    alt="Keycloak SCIM Filtering Configuration" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/team/idp-sync/keycloak-sync/netbird-verify-users.png"
    alt="NetBird Verify Users" className="imagewrapper-big"/>
</p>
