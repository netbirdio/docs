...
<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/1-create-with-provider.png" alt="The Authentik Applications list with the Create with Provider button" className="imagewrapper-big"/>
</p>
        - Name the Application and select a suitable explicit user flow. In the example below, we used NetBird:

<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/2-new-application.png" alt="Naming the Authentik application and choosing an explicit user flow" className="imagewrapper-big"/>
</p>

    - Click Next and select the OAuth2/OpenID Provider Type:

<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/3-new-application-type.png" alt="Selecting OAuth2/OpenID Provider as the Authentik provider type" className="imagewrapper-big"/>
</p>

    - Click Next and select an explicit user authorization flow, then take note of the Client ID and Client Secret:
<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/4-new-application-client-id.png" alt="The Authentik provider screen showing the Client ID and Client Secret" className="imagewrapper-big"/>
</p>

    - Add the following redirect URL and select a signing key: <br/>
    URL: `https://login.netbird.io/login/callback`
<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/5-new-application-sign.png" alt="Entering the NetBird redirect URL and selecting a signing key in Authentik" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/6-new-application-scopes.png" alt="Authentik Advanced protocol settings with the openid, email, and profile scopes selected" className="imagewrapper-big"/>
</p>

    - Click Next on the following two screens and Submit to create the provider and application:

<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/7-new-application-submit.png" alt="The final Authentik confirmation screen before submitting the provider and application" className="imagewrapper-big"/>
</p>

    - You should see an application listed as follow:

<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/8-list-applications.png" alt="The new NetBird application listed in Authentik" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/team/single-sign-on/authentik-idp/9-list-providers.png" alt="The Authentik Providers list showing the OpenID Configuration URL" className="imagewrapper-big"/>
</p>
