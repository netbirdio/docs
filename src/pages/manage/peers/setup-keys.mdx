...
<p>
    <img src="/docs-static/img/manage/peers/setup-keys.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/peers/netbird-peer-auto-tagging-newkey.png" alt="high-level-dia" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/peers/add-setup-key.png" alt="high-level-dia" className="imagewrapper"/>
</p>

After your key has been successfully created, copy and store it in a secure location.

<p>
    <img src="/docs-static/img/manage/peers/setup-key-created.png" alt="high-level-dia" className="imagewrapper"/>
</p>
