...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/setup-keys-add-servers-to-network/setup-keys-add-server-01.png"
    alt="NetBird Generating Setup Key" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/setup-keys-add-servers-to-network/setup-keys-add-server-02.png"
    alt="NetBird Peers View" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/setup-keys-add-servers-to-network/setup-keys-add-server-03.png"
    alt="NetBird Peers IP Address or Domain" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/setup-keys-add-servers-to-network/setup-keys-add-server-04.png"
    alt="NetBird Welcome Page" className="imagewrapper-big"/>
</p>
