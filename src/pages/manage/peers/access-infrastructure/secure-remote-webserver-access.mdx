...
* [NetBird installed](/getting-started/install) on your local machine.
...
![NetBird Local Peer](/docs-static/img/manage/peers/local-peer.png)
...
* Configure the key by assigning it a descriptive name (e.g., "Remote Web Server"), setting an expiration date, and defining auto-assigned groups (if required). Read the documentation for [detailed setup key configuration](/manage/peers/setup-keys).
* Copy the generated key to a secure location as you'll need it shortly

![NetBird Creating Setup Key](/docs-static/img/manage/peers/new-key-remote-web-server.png)
...
![NetBird Peers Network](/docs-static/img/manage/peers/netbird-peer-page.png)
...
![NetBird Access Policy](/docs-static/img/manage/access-control/update-policy.png)
...
![NetBird Web Server Peer](/docs-static/img/manage/peers/netbird-peer-page.png)
...
![NetBird IP Addresses](/docs-static/img/manage/peers/netbird-ip-dns-preview.png)
...
![NetBird Local User Peer](/docs-static/img/manage/peers/netbird-peer-page.png)
...
![Terminal No Access to Web Server](/docs-static/img/manage/peers/ping-netbird-ip.png)

There is no response from the host. Now, ping the web server from your configured local machine:

![Terminal Access to Web Server](/docs-static/img/manage/peers/ping-netbird-ip-2.png)
...
![Terminal Fastfetch from Web Server](/docs-static/img/manage/peers/web-server-fastfetch.png)
