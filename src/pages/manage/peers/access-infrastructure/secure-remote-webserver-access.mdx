...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/owyUeUn.png"
    alt="NetBird Local Peer" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/jQ5rhEb.png"
    alt="NetBird Creating Setup Key" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/8I1WVEx.png"
    alt="NetBird Peers Network" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/AgB9Asr.png"
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/QXb6lLs.png"
    alt="NetBird Web Server Peer" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/EVZssES.png"
    alt="NetBird IP Addresses" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/LoNxwd4.png"
    alt="NetBird Local User Peer" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/iHiFujr.png"
    alt="Terminal No Access to Web Server" className="imagewrapper-big"/>
</p>

There is no response from the host. Now, ping the web server from your configured local machine:

<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/HKsAcFE.png"
    alt="Terminal Access to Web Server" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/ssh-webserver-netbird.png"
    alt="Terminal SSH into Web Server using NetBird domain" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/secure-remote-webserver-access/YoECY8k.png"
    alt="Terminal Fastfetch from Web Server" className="imagewrapper-big"/>
</p>
