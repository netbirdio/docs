...
* [NetBird installed](/getting-started/install) on the main device.
...
Upon logging in, you'll arrive at NetBird's Peers dashboard. Locate and click the `Add Peer` button to initiate the [Getting Started](/getting-started) Wizard, which guides you through the process of adding a new device to the network.
...
The wizard will detect your operating system and provide detailed step-by-step instructions on how to [install NetBird](/getting-started/install).
