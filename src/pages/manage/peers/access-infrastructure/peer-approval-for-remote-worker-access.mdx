...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-0-01.png"
    alt="NetBird Freelancer Access Control Policy" className="imagewrapper-big"/>
</p>

If necessary, you can also set [posture checks](/manage/access-control/posture-checks) for this policy.

<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-0-02.png"
    alt="NetBird Freelancer Posture Check" className="imagewrapper-big"/>
</p>

Moreover, it is a best practice to disable the `Default` policy to enforce only restrictive, custom-defined access controls.

<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-0-03.png"
    alt="NetBird Access Policy View" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-02.png"
    alt="NetBird Freelancer Device Dashboard" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-03.png"
    alt="NetBird Invite Users" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-04.png"
    alt="NetBird Invite User Pop Up" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-05.png"
    alt="NetBird New User Pending" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-06.png"
    alt="Email NetBird Invitation" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-07.png"
    alt="NetBird Login" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-08.png"
    alt="NetBird Freelancer Peers Dashboard" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-09.png"
    alt="NetBird Freelancer Install Client" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-10.png"
    alt="NetBird Authorize App" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-11.png"
    alt="NetBird Freelancer Peers Listed" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-12.png"
    alt="NetBird Peers Dashboard" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-13.png"
    alt="NetBird Approve New Peer" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-16.png"
    alt="NetBird Freelancer Peers View" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-17.png"
    alt="NetBird Main Account Peers View" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/peer-approval-for-remote-worker-access/peer-a-18.png"
    alt="NetBird EDR Integration" className="imagewrapper-big"/>
</p>
