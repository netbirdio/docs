...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-01.png"
    alt="NetBird Setup Keys" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-02.png"
    alt="NetBird Add Route" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-03.png"
    alt="NetBird Create a New Route" className="imagewrapper-big"/>
</p>

Provide a descriptive name for your route, such as `NetBird K8s Demo`.

<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-04.png"
    alt="NetBird Route Name" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-06.png"
    alt="NetBird Network Route Created" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-07.png"
    alt="NetBird Access Policy" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-08.png"
    alt="NetBird Access Policy Name" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-09.png"
    alt="NetBird Access Policies" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-10.png"
    alt="NetBird App Joined NetBird" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-11.png"
    alt="NetBird Two Peers" className="imagewrapper-big"/>
</p>

As you can see, all peers join the same group, meaning all share the same access policy you defined.

<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-12.png"
    alt="NetBird Three Peers" className="imagewrapper-big"/>
</p>

Conversely, when scaling down, peers are removed from the group and then terminated.

<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-13.png"
    alt="NetBird Scaling Down Peers" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/peers/access-infrastructure/access-internal-resources-from-autoscaled-environments/autoscaled-14.png"
    alt="NetBird Initial State" className="imagewrapper-big"/>
</p>
