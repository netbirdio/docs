...
* [NetBird](/getting-started/install) installed on your local machine
...
The first step in this process is [creating a NetBird setup key](/manage/peers/setup-keys) for your Kubernetes cluster. This setup key serves as a secure authentication token, allowing your cluster's pods to join your NetBird network seamlessly.
...
![NetBird Setup Keys](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-01.png)
...
![NetBird Add Route](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-02.png)
...
![NetBird Create a New Route](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-03.png)

Provide a descriptive name for your route, such as `NetBird K8s Demo`.

![NetBird Route Name](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-04.png)
...
![NetBird Network Route Created](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-06.png)
...
![NetBird Access Policy](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-07.png)


Click `Continue` and name your policy:

![NetBird Access Policy Name](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-08.png)
...
![NetBird Access Policies](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-09.png)
...
![NetBird App Joined NetBird](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-10.png)
...
![NetBird Two Peers](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-11.png)

As you can see, all peers join the same group, meaning all share the same access policy you defined.

![NetBird Three Peers](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-12.png)

Conversely, when scaling down, peers are removed from the group and then terminated.

![NetBird Scaling Down Peers](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-13.png)
...
![NetBird Initial State](/docs-static/img/manage/peers/access-infrastructure/setup-keys-access-internal-resources-autoscaled-env/autoscaled-14.png)
