...
For detailed CLI usage, see the [CLI documentation](/getting-started/cli#ssh).
...
For complete CLI command reference, including all SSH-related commands and flags, see the [CLI documentation](/getting-started/cli#ssh).
