...
- **Default to a routing peer** for "let my peers reach a service in this cluster." One routing peer fronts many services and is the cheapest to operate — see the [Route to a Kubernetes service](/use-cases/cloud/route-to-a-kubernetes-service) how-to, including how to run it highly available.
