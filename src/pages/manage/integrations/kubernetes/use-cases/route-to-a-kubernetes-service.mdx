...
<p>
  <img src="/docs-static/img/manage/integrations/kubernetes/ha-routing-peers-spread-nodes.svg" alt="A NetBird client reaching a Kubernetes service through three routing-peer pods, one per node" className="imagewrapper-big"/>
</p>
