...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-01.png"
    alt="Access control policy for the support team" className="imagewrapper-big"/>
</p>

Give the policy a descriptive name (e.g., "Support team remote access") and click `Save` to create the policy.

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-02.png"
    alt="Access control policies list" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-03.png"
    alt="Uploading NetBird package" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-04.png"
    alt="Jamf Pro policies, general section" className="imagewrapper-big"/>
</p>

In the `Packages` section, click `Configure` and add the corresponding NetBird package:

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-05.png"
    alt="Jamf Pro policies, packages section" className="imagewrapper-big"/>
</p>

Accept the default values for **Distribution Point** and **Action**

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-06.png"
    alt="Jamf Pro policies, packages section" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-07.png"
    alt="Jamf Pro policies, target computers" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-08.png"
    alt="Jamf Pro policies, user interaction" className="imagewrapper-big"/>
</p>

Click `Save` to finish.

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-09.png"
    alt="NetBird policy" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/jamf-pro-netbird-integration//netbird-jamf-10.png"
    alt="Jamf Pro, confirming NetBird is installed" className="imagewrapper-big"/>
</p>
