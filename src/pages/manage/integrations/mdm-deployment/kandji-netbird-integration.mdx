...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-01.png"
    alt="Creating a new access policy for the Support team" className="imagewrapper-big"/>
</p>

Give the policy a descriptive name (e.g., Support team remote access) and click `Save` to create the policy.

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-02.png"
    alt="Support team access policy" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-04.png"
    alt="Creating a new Custom App in Kandji" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-05.png"
    alt="Creating a new Custom App in Kandji" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-06.png"
    alt="Manage Tags in Kandji" className="imagewrapper-big"/>
</p>

A new pop-up window will appear; click `+ Add tag`, enter a name for the tag (e.g., `Support`), and click `Save`.

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-07.png"
    alt="Creating a new Tag" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-08.png"
    alt="Creating a new Blueprint" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-09.png"
    alt="Blank Blueprint" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-10.png"
    alt="Add new Block to the Blueprint" className="imagewrapper-big"/>
</p>

Next, click the pencil icon to edit the rules.

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-11.png"
    alt="Add Logic to the Blueprint" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-12.png"
    alt="Using Tags to target the support team" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-13.png"
    alt="Add NetBird custom app to Blueprint logic" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-14.png"
    alt="Finished Blueprint" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-15.png"
    alt="Verifying Blueprint logic" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/kandji-netbird-integration//netbird-kandji-16.png"
    alt="Verifying peer in NetBird" className="imagewrapper-big"/>
</p>
