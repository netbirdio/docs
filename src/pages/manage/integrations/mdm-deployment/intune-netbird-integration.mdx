...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-01.png"
    alt="Create Access Control Policy" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-02.png"
    alt="New control access policy" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-03.png"
    alt="Adding Windows App" className="imagewrapper-big"/>
</p>

- Click the `+ Create` button to add a new Windows application

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-04.png"
    alt="Create Windows App" className="imagewrapper-big"/>
</p>

- In the `App type` dropdown, select `Windows app (Win32)` and click `Select`

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-14.png"
    alt="Win32 app" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-15.png"
    alt="Upload NetBird Intunewin" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-16.png"
    alt="NetBird Configuration" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-17.png"
    alt="Program tab" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-18.png"
    alt="Requirements tab" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-19.png"
    alt="Detection Rules tab" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-20.png"
    alt="Add Groups to NetBird App" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-09.png"
    alt="Assign Groups" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-21.png"
    alt="Review Configuration" className="imagewrapper-big"/>
</p>

- To verify that NetBird was added to Intune, navigate to `Apps > All Apps` to see your Windows applications:

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-22.png"
    alt="Windows App Catalog" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-05.png"
    alt="LOB app" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-06.png"
    alt="Upload NetBird MSI" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-07.png"
    alt="NetBird Configuration" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-08.png"
    alt="Add Groups to NetBird App" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-11.png"
    alt="Review Configuration" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-12.png"
    alt="NetBird App Overview" className="imagewrapper-big"/>
</p>

To verify that NetBird was added to Intune, navigate to `Home > Apps | Windows` to see all your Windows applications:

<p>
  <img src="/docs-static/img/manage/integrations/mdm-deployment/intune-netbird-integration/intune-13.png"
    alt="Windows App Catalog" className="imagewrapper-big"/>
</p>
