...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-01.png"
    alt="Access Control Policy settings" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-02.png"
    alt="Access Control Policy name" className="imagewrapper"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-03.png"
    alt="Access Control Policy list" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-04.png"
    alt="Add package" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-05.png"
    alt="General information" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-06.png"
    alt="Upload package" className="imagewrapper-big"/>
</p>

Select the NetBird installer file from your local system. Once the upload completes, click `Next` to proceed.

<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-07.png"
    alt="Upload package" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-08.png"
    alt="Install / Uninstall commands" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-09.png"
    alt="Summary" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-10.png"
    alt="Digital signature check" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-11.png"
    alt="My packages list" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-12.png"
    alt="Install NetBird from My packages" className="imagewrapper-big"/>
</p>

In the `Deploy software` window, click `+ Add workloads` and select your target machines from the available endpoints.

<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-13.png"
    alt="Add workloads" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-14.png"
    alt="Windows-11 Workload" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-15.png"
    alt="Activities menu" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-16.png"
    alt="Software inventory" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-17.png"
    alt="Install NetBird from All devices" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-18.png"
    alt="Software deployment plans" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-19.png"
    alt="Create software deployment plan" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-20.png"
    alt="Selecting workloads" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-22.png"
    alt="Add NetBird EXE PowerShell script" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-23.png"
    alt="Add NetBird MSI PowerShell script" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-24.png"
    alt="Add NetBird Uninstaller PowerShell script" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-25.png"
    alt="Script quick run" className="imagewrapper-big"/>
</p>

Next, you can select the workloads where you want to run the script and click the `Run now` button.

<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-26.png"
    alt="Run Script" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-27.png"
    alt="Create Scripting Plan" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-28.png"
    alt="Manually Running a Scripting Plan" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-macos-01.png"
    alt="Add NetBird Bash Script script" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-macos-02.png"
    alt="Quick Run NetBird Bash Script script" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-macos-03.png"
    alt="Quick Run NetBird Bash Script script" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/for-partners/acronis-windows-netbird-integration/acronis-windows-21.png"
    alt="Windows 11 Peer" className="imagewrapper-big"/>
</p>