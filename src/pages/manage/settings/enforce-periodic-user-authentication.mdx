...
In the Peers section of the web UI (either `User Devices` or `Servers`) click on the peer you want to disable expiration for and use the Login Expiration switch.
