...
The IPv6 network range is configured alongside your IPv4 range. Valid prefix lengths are `/48` through `/112`. The default is a `/64` prefix, which provides enough addresses for most deployments.
