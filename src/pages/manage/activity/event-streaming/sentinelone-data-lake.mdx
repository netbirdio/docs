...
<p>
    <img src="/docs-static/img/manage/activity/event-streaming/sentinelone-data-lake/api-key-generation.png" alt="Generating a write API key in the SentinelOne console" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/activity/event-streaming/sentinelone-data-lake/general-settings.png" alt="The Generic HTTP General tab, with the SentinelOne HEC endpoint URL and Bearer Token authentication" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/activity/event-streaming/sentinelone-data-lake/custom-template.png" alt="The Generic HTTP Body Template tab, with the custom template shaped for the SentinelOne HTTP Event Collector" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/activity/event-streaming/sentinelone-data-lake/verify-integration.png" alt="SentinelOne Data Lake search results showing the NetBird test event and the integration created event" className="imagewrapper-big"/>
</p>
