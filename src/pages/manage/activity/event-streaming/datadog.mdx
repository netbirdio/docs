...
<p>
  <img src="/docs-static/img/manage/activity/event-streaming/datadog/datadog-region-select.png" alt="Step one of the Datadog wizard, selecting the Datadog site from the region dropdown" className="imagewrapper" />
</p>
- Under `Get your Datadog API Key`, paste the API key you created above into the input field and click `Connect`
<p>
    <img src="/docs-static/img/manage/activity/event-streaming/datadog/datadog-api-key.png" alt="Step two of the Datadog wizard, pasting the Datadog API key" className="imagewrapper" />
</p>
...
<p>
    <img src="/docs-static/img/manage/activity/event-streaming/datadog/verify-datadog-integration.png" alt="The Datadog Log Explorer showing events arriving from the netbird service" className="imagewrapper"/>
</p>
