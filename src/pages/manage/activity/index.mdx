...
<p>
    <img src="/docs-static/img/manage/activity/activity-monitoring.png" alt="The Audit Events feed in the NetBird dashboard, listing recent configuration changes with their initiator and timestamp" className="imagewrapper-big"/>
</p>
