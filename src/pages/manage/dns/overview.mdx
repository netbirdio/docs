...
│              NetBird Peer (Client)              │
│                                                 │
│  • NetBird IP: 100.x.y.z (from management)      │
│  • LAN IP: 192.168.1.x (from LAN DHCP)          │
│                                                 │
│  ┌───────────────────────────────────────────┐  │
│  │   Local DNS Resolver (100.x.255.254:53)   │  │
│  │                                           │  │
...
- **NetBird IPs**: Management assigns each peer a unique IP from a random /16 block within the `100.64.0.0/10` CGNAT range (e.g., `100.121.x.x`). This range can be customized.
