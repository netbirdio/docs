...
- **Active Directory.** A domain-joined client always needs a nameserver (`corp.example.com` → the DC), no matter how this setting is configured — see [Reaching a Domain Controller through a routing peer](#reaching-a-domain-controller-through-a-routing-peer).
</Note>
