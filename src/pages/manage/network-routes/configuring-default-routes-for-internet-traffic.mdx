...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-peers.png" alt="dashboard-peers-view"
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-peers-routing-peer.png" alt="routing-peer-view"
         className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-peers-add-exit-node.png" alt="add-exit-node-view"
         className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/exit-node-auto-apply.png" alt="exit-node-auto-apply" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-peers-routing-peer-exit-node.png" alt="routing-peer-exit-node-view"
         className="imagewrapper-big"/>
</p>
