...
### 1. Open the Peers section

Navigate to the NetBird dashboard and open **Peers** → **User Devices** (or **Peers** → **Servers** if the exit-node candidate is an unattended machine).
