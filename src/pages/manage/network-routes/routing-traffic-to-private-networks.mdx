...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-dns-routes.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-add-button.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-create.png" alt="high-level-dia" className="imagewrapper" width="70%"/>
</p>


Once you fill in the route information, you can click on the `Add Route` button to save your new route.
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-saved-new.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-groups-create.png" alt="high-level-dia" className="imagewrapper" width="70%"/>
</p>

Once you fill in the route information, you can click on the `Add Route` button to save your new route.

<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-groups-saved-new.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-create-ha.png" alt="high-level-dia" className="imagewrapper" width="70%"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-saved-new-ha.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-groups-attribution.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/netbird-network-routes-masquerading.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
