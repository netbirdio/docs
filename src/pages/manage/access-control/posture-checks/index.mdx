...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-01.png"
    alt="NetBird Posture Checks" className="imagewrapper-big"/>
</p>

A pop-up window will open with two tabs: `Checks` and `Name & Description`.

<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-02.png"
    alt="Create Posture Check" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-03.png"
    alt="NetBird Client Version Posture Check" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-04.png"
    alt="Country and Region Posture Check" className="imagewrapper-big"/>
</p>
<Note>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-05.png"
    alt="Peer Network Range Posture Check" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-06.png"
    alt="Operating System Posture Check" className="imagewrapper-big"/>
</p>
<Note>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-07.png"
    alt="Process Posture Check" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-08.png"
    alt="Name your Posture Check" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-09.png"
    alt="New Posture Check" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-10.png"
    alt="Add Posture Check to Access Control Policy" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-11.png"
    alt="Access Control Policies Dashboard" className="imagewrapper-big"/>
</p>
...
<p>
  <img src="/docs-static/img/manage/access-control/posture-checks/posture-checks-12.png"
    alt="Posture Checks Dashboard" className="imagewrapper-big"/>
</p>
